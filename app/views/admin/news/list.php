<div class="container-xl">
    ...
    <div class="card">
        ...
        <div class="card-footer d-flex align-items-center">
            ...
            <?php $searchQuery = isset($_GET['search']) && $_GET['search'] != '' ? '&search=' . urlencode($_GET['search']) : ''; ?>

            <ul class="pagination m-0 ms-auto">
                <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                    <a class="page-link" href="<?= URLROOT ?>/public/index.php?url=admin/news/list&page=<?= $page - 1 ?><?= $searchQuery ?>">
                        Trước
                    </a>
                </li>
                ...
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <?php if ($i == 1 || $i == $totalPages || ($i >= $page - 2 && $i <= $page + 2)): ?>
                        <li class="page-item <?= ($page == $i) ? 'active' : '' ?>">
                            <a class="page-link" href="<?= URLROOT ?>/public/index.php?url=admin/news/list&page=<?= $i ?><?= $searchQuery ?>">
                                <?= $i ?>
                            </a>
                        </li>
